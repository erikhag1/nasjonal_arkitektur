...
Det skal være enkelt å komme i gang med å bidra til innhold i dette biblioteket. Se [red yellow-background]#<<../Hvordan_komme_igang/Tips_for_å_komme_i_gang.adoc, Tips for å komme i gang>>#.
////
https://github.com/difi/nasjonal_arkitektur/blob/master/Hvordan_komme_igang/Tips_for_%C3%A5_komme_i_gang.adoc
