:lang: no
:revdate: 2018-08-18
:title_en: Introduction to Documentation conventions
:title_no: Introduksjon til dokumentasjonskonvensjoner
...
Eksisterende innhold i diverse formater og verktøy for tekst og multimedia kan lenkes til innhold og oversikter i det GitHub-baserte arkitekturbiblioteket, uten at filene flyttes tli GitHub eller konverteres til nye formater. Se #TBD# for mer om dette.
