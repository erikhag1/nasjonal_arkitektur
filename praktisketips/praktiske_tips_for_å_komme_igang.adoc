...
Forslag: Start med den enkleste malen først. Derosm du er i tvil om hvor i arkitekturbiblioteket dokumentet ditt hører hjemme, eller du bare vil eksperimentere, kan du benytte ditt personlige område. 

Tips: Start med å ko


så avansert du måtte ønske, eller noe midt i mellom. Her er noen tips:
